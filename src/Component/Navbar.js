  ...
  return (
    <>
      <div className="Parentnavbar position-relative">
        ...
        <a className="navbutton bg-dark text-white" href="https://academy.vidyaverse.in/account/signup?returnUrl=/publisher/planandbilling/index" style={{textDecoration: "none"}}>Login</a>
        ...
        </button>
        {
          toggleMenu ?
            <div className="navbar-menu">
              ...
              <a className="navbar-menu-btn bg-white text-dark" href="https://academy.vidyaverse.in/account/signup?returnUrl=/publisher/planandbilling/index" style={{textDecoration: "none"}}>Login</a>
            </div> : null
        }
